...
static NSString * const kPageLink = @"https://itunes.apple.com/us/app/scenery-wallpaper/id823463061?ls=1&mt=8";

- (NSString *)signatureString {
    return [NSString stringWithFormat:@"Sent from <a href=%@>Scenery Wallpaper</a> on iPhone.<hr>", kPageLink];
}
...
- (void)sendEmail {
    if ([MFMailComposeViewController canSendMail]) {
        ...
        NSString *emailTitle = @"Scenery Wallpaper";
        NSString *bodyString = @"";
